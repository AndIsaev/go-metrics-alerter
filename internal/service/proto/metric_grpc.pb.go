...
const (
	MetricService_InsertBatch_FullMethodName = "/met.MetricService/InsertBatch"
)
...
func (c *metricServiceClient) InsertBatch(ctx context.Context, in *InsertBatchRequest, opts ...grpc.CallOption) (*InsertBatchResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InsertBatchResponse)
	err := c.cc.Invoke(ctx, MetricService_InsertBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMetricServiceServer) InsertBatch(context.Context, *InsertBatchRequest) (*InsertBatchResponse, error) {
...
func _MetricService_InsertBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InsertBatchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetricServiceServer).InsertBatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetricService_InsertBatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricServiceServer).InsertBatch(ctx, req.(*InsertBatchRequest))
	}
...
var MetricService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "met.MetricService",
	HandlerType: (*MetricServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "InsertBatch",
			Handler:    _MetricService_InsertBatch_Handler,
		},
	},
